...
export default function Register({navigation}) { //state
...
const NotifineHandler=() => Alert.alert('Bạn đăng kí thành công ','Mời bạn đăng nhập',[ { text: "OK", onPress: () => navigation.navigate('Login')}])
return (
  <KeyboardAvoidingView
